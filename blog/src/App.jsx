...
function App() {
  ...
  function openMenu(evt, menuName) {
    ...
    tablinks.forEach((tablink) => {
      tablink.classNameList.remove('w3-dark-grey');
    });

    document.getElementById(menuName).style.display = 'block';
    evt.currentTarget.firstElementChild.classNameList.add('w3-dark-grey');
  }
      ...
      <div className="w3-sand w3-grayscale w3-large">
        ...
        >
          <div className="w3-content" style={{ maxWidth: '700px' }}>
            ...
            />
            <p>
              <span className="w3-tag">FYI!</span> We offer full-service
              catering for any event, large or small. We understand your needs
              and we will cater the food to satisfy the biggerst criteria of

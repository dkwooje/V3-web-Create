  ...
  return (
    <>
      ...
      <div class="w3-sand w3-grayscale w3-large">
        ...
        <div class="w3-container" id="where" style="padding-bottom: 32px">
          <div class="w3-content" style="max-width: 700px">
            ...
            />
            <p>
              <span class="w3-tag">FYI!</span> We offer full-service catering
              for any event, large or small. We understand your needs and we
              will cater the food to satisfy the biggerst criteria of them all,
              both look and taste.
            </p>
            <p>
      ...
      <footer class="w3-center w3-light-grey w3-padding-48 w3-large">
        ...
        <a
          class="w3-button w3-round-xxlarge w3-dark-grey w3-margin-bottom"
